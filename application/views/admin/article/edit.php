                            ...
                            <select  name="category_id" class="form-control <?php echo (form_error('category_id') != "") ? 'is-invalid' : '';?>" id="category_id">
                                ...
                                if (!empty($categories)) {
                                    foreach ($categories as $category) {
                                        ...
                                        ?>
                                        <option <?php echo set_select('category_id',$category['categories_ID'],$selected);?> value="<?php  echo $category['categories_ID'];?>"><?php echo $category['name'];?></option>
                                        <?php
                                    }
                                }
                                ?>
                        ...
                        <div class="form-group">
                            ...
                            $path='./public/uploads/articles/'.$article['image'];
                             if($article['image']!= "" && file_exists($path)){
                                ?>
                                <img class="mt-3"src="<?php echo base_url('public/uploads/articles/'.$article['image']);?>">
                                <?php
                             }
